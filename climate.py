...
class EphEmberThermostat(ClimateEntity):
    ...
    def preset_mode(self):
        ...
        return 'boost' if zone_is_boost_active(self._zone) else 'none'
    ...
    def turn_on(self) -> None:
        self._ember.set_zone_mode(self._zone_name, ZoneMode.ON)

    def turn_off(self) -> None:
        self._ember.set_zone_mode(self._zone_name, ZoneMode.OFF)
